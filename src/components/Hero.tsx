        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="flex-1 text-center lg:text-left animate-slide-in">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl">
              ...
              seamless web experiences. Currently pursuing MCA at Lovely Professional
              University, with expertise in modern web technologies.
            </p>
          ...
          <div className="flex-1 flex justify-center animate-scale-in">
            <div className="relative">
              ...
              <img
                src={profileImage}
                alt="Aryan Pratap Singh"
                className="relative w-72 h-72 md:w-96 md:h-96 rounded-full object-cover border-4 border-primary shadow-2xl"
              />
            </div>
          </div>
        </div>
